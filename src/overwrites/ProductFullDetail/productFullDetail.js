...
const ProductFullDetail = props => {
    ...
    const talonProps = useProductFullDetail({
        ...
        getLocationStore: GET_LOCATION_STORE,
        product
    });
    ...
    const classes = mergeClasses(defaultClasses, ctmStyle, props.classes);
    ...
    const popupStore = isShowPopup && (
        <div className={classes.popUpstore} onClick={handleShowPopup}>
            <div className={classes.popup}>
                <div className={classes.headPopup}>

                    <h2>Available pickup store</h2>
                    <svg
                ...
                <ul className={classes.listStorePopup}>
                    {
                        listStorePickUp.map((item,index)=>(
                            <li key={index} className={classes.storePopupItem}>
                        <p className={classes.storeName}>{item.name}</p>
                        <p className={classes.storeAddreess}>{item.street} {item.state_province} {item.city} {item.country}</p>
                    </li>
                        ))
                    }
    ...
    return (
        <Fragment>
            ...
            <Form className={classes.root}>
                ...
                {
                    storePickUpID.length >=0 &&
                    <section className={classes.avaiablePickUp}>
                        <p onClick={handleShowPopup}>See available pickup stores</p>
                    </section>
                }
