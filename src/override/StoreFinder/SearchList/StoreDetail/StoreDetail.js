...
import chevronup from './chevrons-up.svg';
import chevrondown from './chevrons-down.svg';
import clockIc from './clock.svg';
...
export const StoreDetailInSearchSpace = props => {
    ...
    const currentHighLightDateIndex =
        nowTime.getHours() >= startTime.getHours() &&
        nowTime.getHours() <= endTime.getHours()
            ? nowTime.getDay()
            : null;
    ...
    return (
        <div
            ...
            style={{
                ...
                width:
                    width > 880
                        ? Math.max(381, (width * 3) / (3.2 + 6) - 2) - 50
                        : 300 - 40,
                maxWidth: 340
            }}
        >
                ...
                <div>
                    ...
                    {!!storeDetails.timeDisplayTemplate && (
                        <>
                            ...
                            >
                                <img src={clockIc} width={20} alt={'clock'} />
                                <h3
                                    style={{
                                        marginLeft: 10,
                                        fontSize: 16,
                                    ...
                                    {DAYS_OF_WEEK.map((day, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    {
                                                        storeDetails.timeSimpleTemplate
                                                    }
                                                </h3>
                                            </div>
                                        );
                    ...
                    {!!storeDetails.telephone &&
                        Number.parseInt(storeDetails.telephone) !== 0 && (
                            <div
                                key={'phone'}
                                style={{
                                    display: 'flex',
                                ...
                                {canShowExtraPhone && (
                                    ...
                                    >
                                        <img
                                            src={
                                                showExtraTime
                                                    ? '@simicart/store_locator/src/override/StoreFinder/SearchList/StoreDetail/chevrons-up.svg'
                                                    : '@simicart/store_locator/src/override/StoreFinder/SearchList/StoreDetail/chevrons-down.svg'
                                            }
                                            width={18}
                                            alt={'extra'}
                                        />
