...
import {LARGE, UPPER_MEDIUM} from "../../../../other/BREAKPOINTS";
...
const StoreCard = (props) => {
    ...
    const todayConstrain = thisWeekTime ? thisWeekTime[currentTime.getDay() - 1] : null
    ...
    const currentTimeDisplayTemplate = (() => {
        ...
        return `Open at ${todayConstrain.from.getHours().toString().padStart(2, '0')}:${todayConstrain.from.getMinutes().toString().padStart(2, '0')}`
    ...
    const timeSimpleTemplate = timeDisplayTemplate ? `${timeData[0].from[0]}:${timeData[0].from[1]} : ${timeData[0].to[0]}:${timeData[0].to[1]}` : ''
               ...
               style={{
                ...
                <div style={{
                    ...
                    <div style={{display: "flex", flexDirection: "row", marginBottom: 7}}>
                        <div style={{flex: 2, paddingRight: width > 880 ? 14 : 10}}>
                            <img
                                src={image}
                                alt={'An img'}
                                style={{
                        ...
                        <div style={{flex: 5, marginRight: 3}}>
                            <h3 style={{
                                marginBottom: 7,
                                fontSize: width > LARGE ? 20 : width > UPPER_MEDIUM ? 19 : 17,
                                fontWeight: "bold"
                            }}>
                                {name}
                            </h3>
                            ...
                            <h4 style={{
                                color: '#555',
                                fontSize: width > LARGE ? 18 : width > UPPER_MEDIUM ? 16 : 14,
                                marginBottom: 10
                            }}>
                                {addressSummary}
                            </h4>
                            ...
                            {!!telephone && (telephone !== '0') && <h4 style={{
                                color: '#555',
                                fontSize: width > LARGE ? 18 : width > UPPER_MEDIUM ? 16 : 14,
                    ...
                    <div style={{
                        ...
                        <button onClick={event => {
                            ...
                            handleDetailPress({
                                ...
                                region: region,
                                countryId: countryId,
                                timeDisplayTemplate: timeDisplayTemplate,
                                timeSimpleTemplate: timeSimpleTemplate,
                                telephone: telephone,
                                telephone_2: (telephone !== telephone_2 && telephone_2 !== '0') ? telephone_2 : ((telephone !== configTelephone && configTelephone !== '0') ? configTelephone : null),
                                email: email,
                                img: image,
                                startTime: timeData ? new Date(0, 0, 0, timeData[0].from[0], timeData[0].from[1], 0) : null,
                                endTime: timeData ? new Date(0, 0, 0, timeData[0].to[0], timeData[0].to[1], 0) : null,
                            })
                        }}>
                            <h3 style={{
                                color: '#55555590',
                                fontWeight: "bold",
                                fontSize: width > LARGE ? 19 : width > UPPER_MEDIUM ? 17 : 15
                            }}>Details +</h3>
                        </button>
                    </div>
                </div>
